...
public class UserController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        Map<String, Object> loginResponse = userService.loginRequest(loginRequest.getUsername(), loginRequest.getPassword());
        if (loginResponse != null) {
            User user = (User) loginResponse.get("user");

            if (user.getGlutenCondition() == null) {
                user.setGlutenCondition(GlutenCondition.Ninguna);
            }
